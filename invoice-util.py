...
def create_docs(user_pdf_list):
    ...
    for filename in user_pdf_list:
        ...
        {context}
        The fields and values in the above content may be jumbled up as they are extracted from a PDF. Please extract
        ...
        'Unit price': xxx.xx', 'Amount': 'xxx.xx, 'Total'; xxx,xx, 'Email': 'xxx@xxx.xxx, 'Phone number': 'xxxxxxx'}}
